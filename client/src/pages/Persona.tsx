...
const USER_TRAITS: TraitCard[] = [
  {
    ...
    description: "高度依赖免佣金、高交互性的移动券商平台（如 Robinhood, Webull, Charles Schwab）以及主流加密货币交易所（如 Coinbase, Kraken）。期望极简的 UI 与即时执行的交易体验。",
  ...
  },
  {
    ...
    description: "信息获取严重依赖去中心化社交网络（Reddit r/wallstreetbets、Twitter/X、Stocktwits、Discord、YouTube、TikTok FinTok）。比起传统财务顾问，更信任同辈社区共识与动能，容易产生 Meme 股/币的暴涨暴跌效应。",
